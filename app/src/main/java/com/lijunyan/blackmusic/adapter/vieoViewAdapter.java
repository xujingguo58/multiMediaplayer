...
public class vieoViewAdapter extends RecyclerView.Adapter<vieoViewAdapter.ViewHolder>
        implements SectionIndexer{

    private static final String TAG = vieoViewAdapter.class.getName();
    ...
    public vieoViewAdapter(Context context, List<MusicInfo> musicInfoList) {
