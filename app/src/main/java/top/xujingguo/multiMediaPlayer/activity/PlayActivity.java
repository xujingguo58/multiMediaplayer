...
//    public static final String ACTION_UPDATE_UI_PLAY_ACTIVITY = "com.lijunyan.blackmusic.activity.playactivity:action_update_ui_broad_cast";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(top.xujingguo.multiMediaPlayer.R.layout.activity_play);
        setStyle();
    ...
    private void initView() {
        backIv = (ImageView) findViewById(top.xujingguo.multiMediaPlayer.R.id.iv_back);
        playIv = (ImageView) findViewById(top.xujingguo.multiMediaPlayer.R.id.iv_play);
        menuIv = (ImageView) findViewById(top.xujingguo.multiMediaPlayer.R.id.iv_menu);
        preIv = (ImageView) findViewById(top.xujingguo.multiMediaPlayer.R.id.iv_prev);
        nextIv = (ImageView) findViewById(top.xujingguo.multiMediaPlayer.R.id.iv_next);
        modeIv = (ImageView) findViewById(top.xujingguo.multiMediaPlayer.R.id.iv_mode);
        curTimeTv = (TextView) findViewById(top.xujingguo.multiMediaPlayer.R.id.tv_current_time);
        totalTimeTv = (TextView) findViewById(top.xujingguo.multiMediaPlayer.R.id.tv_total_time);
        musicNameTv = (TextView) findViewById(top.xujingguo.multiMediaPlayer.R.id.tv_title);
        singerNameTv = (TextView) findViewById(top.xujingguo.multiMediaPlayer.R.id.tv_artist);
        seekBar = (SeekBar) findViewById(top.xujingguo.multiMediaPlayer.R.id.activity_play_seekbar);
...
//                seekBar_touch = true;	//可以拖动标志
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case top.xujingguo.multiMediaPlayer.R.id.iv_back:
                onBackPressed();
                break;
            case top.xujingguo.multiMediaPlayer.R.id.iv_mode:
                switchPlayMode();
                break;
            case top.xujingguo.multiMediaPlayer.R.id.iv_play:
                play();
                break;
            case top.xujingguo.multiMediaPlayer.R.id.iv_next:
                MyMusicUtil.playNextMusic(this);
                break;
            case top.xujingguo.multiMediaPlayer.R.id.iv_prev:
                MyMusicUtil.playPreMusic(this);
                break;
            case top.xujingguo.multiMediaPlayer.R.id.iv_menu:
                showPopFormBottom();
                break;
        }
    }
...
//        }
    ...
    private void setSeekBarBg(){
        try {
            int progressColor = CustomAttrValueUtil.getAttrColorValue(top.xujingguo.multiMediaPlayer.R.attr.colorPrimary, top.xujingguo.multiMediaPlayer.R.color.colorAccent,this);
    ...
    public void showPopFormBottom() {
        ...
        playingPopWindow.showAtLocation(findViewById(top.xujingguo.multiMediaPlayer.R.id.activity_play), Gravity.BOTTOM|Gravity.CENTER_HORIZONTAL, 0, 0);
