...
public class ScanActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(top.xujingguo.multiMediaPlayer.R.layout.activity_scan);
        dbManager = DBManager.getInstance(ScanActivity.this);
        scanBtn = (Button) findViewById(top.xujingguo.multiMediaPlayer.R.id.start_scan_btn);
        setScanBtnBg();
        toolbar = (Toolbar) findViewById(top.xujingguo.multiMediaPlayer.R.id.scan_music_toolbar);
        scanProgressTv = (TextView) findViewById(top.xujingguo.multiMediaPlayer.R.id.scan_progress);
        scanCountTv = (TextView) findViewById(top.xujingguo.multiMediaPlayer.R.id.scan_count);
        scanPathTv = (TextView) findViewById(top.xujingguo.multiMediaPlayer.R.id.scan_path);
        filterCb = (CheckBox) findViewById(top.xujingguo.multiMediaPlayer.R.id.scan_filter_cb);
        scanView = (ScanView) findViewById(top.xujingguo.multiMediaPlayer.R.id.scan_view);
...
//                                msg.setData(data);
    ...
    private void setScanBtnBg(){
        int defColor = CustomAttrValueUtil.getAttrColorValue(top.xujingguo.multiMediaPlayer.R.attr.colorAccent, top.xujingguo.multiMediaPlayer.R.color.colorAccent,this);
        int pressColor = CustomAttrValueUtil.getAttrColorValue(top.xujingguo.multiMediaPlayer.R.attr.press_color, top.xujingguo.multiMediaPlayer.R.color.colorAccent,this);
