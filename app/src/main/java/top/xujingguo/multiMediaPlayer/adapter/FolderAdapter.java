...
//        Button deleteBtn;
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            this.swipeContent = (View) itemView.findViewById(top.xujingguo.multiMediaPlayer.R.id.model_swipemenu_layout);
            this.contentLl = (LinearLayout) itemView.findViewById(top.xujingguo.multiMediaPlayer.R.id.model_music_item_ll);
            this.folderIv = (ImageView) itemView.findViewById(top.xujingguo.multiMediaPlayer.R.id.model_head_iv);
            this.folderName = (TextView) itemView.findViewById(top.xujingguo.multiMediaPlayer.R.id.model_item_name);
            this.count = (TextView) itemView.findViewById(top.xujingguo.multiMediaPlayer.R.id.model_music_count);
//            this.deleteBtn = (Button) itemView.findViewById(R.id.model_swip_delete_menu_btn);
    ...
    public FolderAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(top.xujingguo.multiMediaPlayer.R.layout.local_model_rv_item, parent, false);
    ...
    public void onBindViewHolder(final FolderAdapter.ViewHolder holder, final int position) {
        ...
        holder.folderIv.setImageResource(top.xujingguo.multiMediaPlayer.R.drawable.folder);
