...
public class HomeListViewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            holder = new Holder();
            convertView = LayoutInflater.from(activity).inflate(top.xujingguo.multiMediaPlayer.R.layout.play_list_view_item,null,false);
            holder.swipView =  (View)convertView.findViewById(top.xujingguo.multiMediaPlayer.R.id.play_list_content_swip_view);
            holder.contentView = (LinearLayout) convertView.findViewById(top.xujingguo.multiMediaPlayer.R.id.play_list_content_ll);
            holder.coverIv = (ImageView) convertView.findViewById(top.xujingguo.multiMediaPlayer.R.id.play_list_cover_iv);
            holder.listName = (TextView) convertView.findViewById(top.xujingguo.multiMediaPlayer.R.id.play_list_name_tv);
            holder.listCount = (TextView) convertView.findViewById(top.xujingguo.multiMediaPlayer.R.id.play_list_music_count_tv);
            holder.deleteBtn = (Button) convertView.findViewById(top.xujingguo.multiMediaPlayer.R.id.playlist_swip_delete_menu_btn);
        ...
        holder.contentView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dataList.size() == 0){
                    ...
                    View view = LayoutInflater.from(activity).inflate(top.xujingguo.multiMediaPlayer.R.layout.dialog_create_playlist,null);
                    final EditText playlistEt = (EditText)view.findViewById(top.xujingguo.multiMediaPlayer.R.id.dialog_playlist_name_et);
        ...
        holder.deleteBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                View view = LayoutInflater.from(activity).inflate(top.xujingguo.multiMediaPlayer.R.layout.dialog_delete_playlist,null);
                final AlertDialog.Builder builder = new AlertDialog.Builder(activity);
                builder.setView(view);
                builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override
