package top.xujingguo.multiMediaPlayer.adapter;
...
public class PlaylistAdapter extends RecyclerView.Adapter<PlaylistAdapter.ViewHolder> {
    ...
    public PlaylistAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(top.xujingguo.multiMediaPlayer.R.layout.local_music_item,parent,false);
    ...
    public void onBindViewHolder(final PlaylistAdapter.ViewHolder holder, final int position) {
        ...
        if (musicInfo.getId() == MyMusicUtil.getIntShared(Constant.KEY_ID)){
            holder.musicName.setTextColor(context.getResources().getColor(top.xujingguo.multiMediaPlayer.R.color.colorAccent));
            holder.musicIndex.setTextColor(context.getResources().getColor(top.xujingguo.multiMediaPlayer.R.color.colorAccent));
            holder.musicSinger.setTextColor(context.getResources().getColor(top.xujingguo.multiMediaPlayer.R.color.colorAccent));
        }else {
            holder.musicName.setTextColor(context.getResources().getColor(top.xujingguo.multiMediaPlayer.R.color.grey700));
            holder.musicIndex.setTextColor(context.getResources().getColor(top.xujingguo.multiMediaPlayer.R.color.grey700));
            holder.musicSinger.setTextColor(context.getResources().getColor(top.xujingguo.multiMediaPlayer.R.color.grey700));
        }
