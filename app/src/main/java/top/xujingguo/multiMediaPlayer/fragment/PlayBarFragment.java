...
import top.xujingguo.multiMediaPlayer.activity.PlayActivity;
...
public class PlayBarFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(top.xujingguo.multiMediaPlayer.R.layout.fragment_playbar,container,false);
        playBarLl = (LinearLayout) view.findViewById(top.xujingguo.multiMediaPlayer.R.id.home_activity_playbar_ll);
        seekBar = (SeekBar) view.findViewById(top.xujingguo.multiMediaPlayer.R.id.home_seekbar);
        playIv = (ImageView)view.findViewById(top.xujingguo.multiMediaPlayer.R.id.play_iv);
        menuIv = (ImageView)view.findViewById(top.xujingguo.multiMediaPlayer.R.id.play_menu_iv);
        nextIv = (ImageView)view.findViewById(top.xujingguo.multiMediaPlayer.R.id.next_iv);
        musicNameTv = (TextView) view.findViewById(top.xujingguo.multiMediaPlayer.R.id.home_music_name_tv);
        singerNameTv = (TextView) view.findViewById(top.xujingguo.multiMediaPlayer.R.id.home_singer_name_tv);
...
//      设置Popupwindow显示位置（从底部弹出）
    ...
    public void setFragmentBb(){
        ...
        int[] attrsArray = {top.xujingguo.multiMediaPlayer.R.attr.play_bar_color };
