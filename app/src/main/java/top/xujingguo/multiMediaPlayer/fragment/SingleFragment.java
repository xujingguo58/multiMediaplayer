...
public class SingleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(top.xujingguo.multiMediaPlayer.R.layout.fragment_single,container,false);
        Collections.sort(musicInfoList);
        recyclerView = (RecyclerView)view.findViewById(top.xujingguo.multiMediaPlayer.R.id.local_recycler_view);
        ...
        playModeRl = (RelativeLayout)view.findViewById(top.xujingguo.multiMediaPlayer.R.id.local_music_playmode_rl);
        playModeIv = (ImageView)view.findViewById(top.xujingguo.multiMediaPlayer.R.id.local_music_playmode_iv);
        playModeTv = (TextView)view.findViewById(top.xujingguo.multiMediaPlayer.R.id.local_music_playmode_tv);
        ...
        sideBarPreTv = (TextView) view.findViewById(top.xujingguo.multiMediaPlayer.R.id.local_music_siderbar_pre_tv);
        sideBar = (SideBar)view.findViewById(top.xujingguo.multiMediaPlayer.R.id.local_music_siderbar);
...
//      设置Popupwindow显示位置（从底部弹出）
    ...
    public void deleteOperate(final View swipeView,final int position,final Context context){
        ...
        View view = inflater.inflate(top.xujingguo.multiMediaPlayer.R.layout.dialog_delete_file,null);
        final CheckBox deleteFile = (CheckBox)view.findViewById(top.xujingguo.multiMediaPlayer.R.id.dialog_delete_cb);
