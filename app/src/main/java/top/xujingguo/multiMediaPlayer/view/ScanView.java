...
public class ScanView extends View {
    ...
    public ScanView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, top.xujingguo.multiMediaPlayer.R.styleable.theme);
        if (typedArray != null) {
            accentColor = typedArray.getColor(top.xujingguo.multiMediaPlayer.R.styleable.theme_accent_color, getResources().getColor(top.xujingguo.multiMediaPlayer.R.color.colorPrimary));
            typedArray.recycle();
        }
    ...
    private void initBitmap() {
        Drawable drawable = tintDrawable(getResources().getDrawable(top.xujingguo.multiMediaPlayer.R.drawable.music_note),ColorStateList.valueOf(accentColor));
